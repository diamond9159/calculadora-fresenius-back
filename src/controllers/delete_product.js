...
if(req.body.id < 12) {return res.send(echo(null,"No puedes eliminar Costos Fijos.",true))}
...
//Inicio Codigo
var user_check = await models.productos.count({
  where: {
    id: req.body.id,
  },
});
if (user_check < 1) {return res.send(echo(null,"Este producto no es válido.",true))}
