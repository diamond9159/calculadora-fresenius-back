...
if(req.body.type != "fresenius" && req.body.type != "otro" && req.body.type) {return res.send(echo(null, "Type inválido.", true))}
if(req.body.categoria != "pediatrica" && req.body.categoria !="polimerica" && req.body.categoria != "diabetes" ) {return res.send(echo(null,"Categoria inválda.",true))}
